export default function ContactForm() {
  return (
    <>
        ...
        <h3 className="text-gray-dark font-28 font-medium capitalize 2xl:py-4">Add new contact</h3>
        </div>
            ...
            <div className="bg-white mt-5 2xl:mt-6">
                <div className="p-5 2xl:p-8 border-b">
                    ...
                    <div>
                        ...
                        <button id="dropdown-phone-button" data-dropdown-toggle="dropdown-phone" className="flex-shrink-0 z-10 inline-flex items-center default-input w-auto border-r-0" type="button">
                        ...
                        <div id="dropdown-phone" className="dropdown-default-position-left z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-52 2xl:w-60 dark:bg-gray-700">
                            <ul className="py-2 font-18 text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-phone-button">
                                <li>
                                    <button type="button" className="inline-flex w-full px-4 py-2 font-18 text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
